    ...
    <div class="uk-flex uk-flex-between uk-width-1-1">
        ...
        <div class="uk-flex">
            ...
            <button class="uk-button uk-button-default uk-border-rounded uk-margin-small-right" id="fl-select-all-button" uk-tooltip="pos: top; title: Select or unselect all items" title="Select or unselect all items">
                <span class="uk-position-relative check active" style="top: -1px;">
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="16px" height="16px"><path d="M 25 2 C 12.309534 2 2 12.309534 2 25 C 2 37.690466 12.309534 48 25 48 C 37.690466 48 48 37.690466 48 25 C 48 12.309534 37.690466 2 25 2 z M 25 4 C 36.609534 4 46 13.390466 46 25 C 46 36.609534 36.609534 46 25 46 C 13.390466 46 4 36.609534 4 25 C 4 13.390466 13.390466 4 25 4 z M 34.988281 14.988281 A 1.0001 1.0001 0 0 0 34.171875 15.439453 L 23.970703 30.476562 L 16.679688 23.710938 A 1.0001 1.0001 0 1 0 15.320312 25.177734 L 24.316406 33.525391 L 35.828125 16.560547 A 1.0001 1.0001 0 0 0 34.988281 14.988281 z"/></svg>
                </span>
                <span class="uk-position-relative uncheck" style="top: -1px;">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="16px" height="16px"><path d="M25,2C12.318,2,2,12.318,2,25c0,12.683,10.318,23,23,23c12.683,0,23-10.317,23-23C48,12.318,37.683,2,25,2z M35.827,16.562 L24.316,33.525l-8.997-8.349c-0.405-0.375-0.429-1.008-0.053-1.413c0.375-0.406,1.009-0.428,1.413-0.053l7.29,6.764l10.203-15.036 c0.311-0.457,0.933-0.575,1.389-0.266C36.019,15.482,36.138,16.104,35.827,16.562z"/></svg>
                </span>
                <span class="check active">Check</span><span class="uncheck">Uncheck</span> all
            </button>
            ...
            <div class="uk-margin-small-right">
                <button class="uk-button uk-button-default uk-border-rounded" id="fl-remove-selected" uk-tooltip="pos: top; title: Delete selected items" title="Delete selected items">
                    <span style="left: 1px;" uk-icon="icon: trash; ratio: .85"></span></button>
            </div>
            ...
            <div>
                <button class="uk-button uk-button-default uk-border-rounded uk-margin-small-right fl-create-folder" data-path="<?= $this->e($currentUrl) ?>" uk-tooltip="pos: top; title: Create new folder" title="Create new folder">
                    <span uk-icon="icon: plus-circle; ratio: .75" class="uk-margin-small-right"></span>
                    <span>Folder</span>
                </button>
            </div>
            ...
            <form action="<?= baseUrl('filemanager/upload') ?>" method="POST" enctype="multipart/form-data" id="fl-upload-form">
                ...
                <label for="fl-upload-files" class="uk-button uk-button-default uk-border-rounded" uk-tooltip="pos: top; title: Upload files" title="Upload files">
                    <span uk-icon="icon: upload; ratio: .8" class="uk-margin-small-right"></span><span>Upload</span>
            ...
            <a class="uk-button uk-button-default uk-border-rounded uk-margin-small-left fl-back-dir-button" href="<?= $backUrl ?>" uk-tooltip="pos: top; title: Go back to previous directory" title="Go back to previous directory">
                <span uk-icon="icon: arrow-left; ratio: 1"></span>Back</a>
